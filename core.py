...
class TriangleData:
    """
        Container for right-triangle data and results.
        Semantics:
            - a, b: legs (catheti)
            - c: hypotenuse
        Flags:
    ...
    def compute_hypotenuse(self):
        """
        Compute hypotenuse c from legs a and b.
            - Both legs (a and b) must be provided (not None).
        Effects:
            - Sets computed c.
            - Sets is_valid = True and is_right = True (the computed triangle is right-angled by definition)
        Raises:
    ...
    def compute_leg(self):
        """
        Compute a missing leg of a right triangle from the hypotenuse and the other (known) leg.
    ...
    def is_right_triangle(self):
        """
        Verify whether the triangle stored in this object is right-angled.
        Effects:
            - Updates is_right (True/False).
        Raises:
            - ValueError - If any side is missing.
        """
    ...
    def is_triangle_possible(self):
        """
        Validate that the triangle is geometrically possible (triangle inequality).
        ...
        Raises:
            - ValueError - If a + b <= c (triangle inequality violated).
        """
...
def validate_required_keys(data: dict[str, str | None]):
    """
        ...
        Parameters:
            - data: Input mapping expected to contain exactly: {'a', 'b', 'c'}.
        Raises:
            - ValueError - If keys are missing or extra keys are present.
        """
    required_keys = {"a", "b", "c"}
...
def proceed_data(data: dict[str, str | None]):
    """
        ...
        Returns:
            - TriangleData - Filled triangle object with computed/verified values and UI message.
        """
